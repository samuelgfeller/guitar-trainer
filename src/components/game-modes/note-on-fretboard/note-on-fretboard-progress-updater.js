 ...
 * combinations
 */
export class NoteOnFretboardProgressUpdater {

    notesAmountForFullProgressBar  = 0;
    ...
    updateProgressBar(correctCount) {
        ...
        percentage = correctCount / this.notesAmountForFullProgressBar * 100;
        movingBarLabel = correctCount;
