import {DualRangeSlider} from "./dual-range-slider.js?v=2.4.1";
import {NoteInKeyGenerator} from "../../../../features/game-modes/note-in-key/note-in-key-generator.js?v=2.4.1";
import {availableNotesOnStrings} from "../../../configuration/config-data.js?v=2.4.1";
import {ModalHandler} from "../../../game-core/ui/modal-handler.js?v=2.4.1";
