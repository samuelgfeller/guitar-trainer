import {GameProgressUpdater} from "../game-core/game-progress/game-progress-updater.js?v=1.2.3";
import {DetectedNoteVerifier} from "../detected-note/detected-note-verifier.js?v=1.2.3";
import {NoteCombinationVisualizer} from "../game-core/game-ui/note-combination-visualizer.js?v=1.2.3";
