import {NoteInKeyGameCoordinator} from "./note-in-key-game-coordinator.js?v=1.1.1";
import {LevelUpVisualizer} from "../../game-core/game-ui/level-up-visualizer.js?v=1.1.1";
...
import {NoteInKeyGenerator} from "./note-in-key-generator.js?v=1.1.1";
import {PracticeNoteDisplayer} from "../../practice-note-combination/practice-note-displayer.js?v=1.1.1";
