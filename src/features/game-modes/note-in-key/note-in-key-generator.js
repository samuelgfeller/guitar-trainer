import {
    ...
    pattern1keyNote,
    pattern2keyNote
} from "../../../components/configuration/config-data.js?v=2.3.3";
import {NoteInKeyShuffler} from "../../../components/game-modes/note-in-key/shuffler/note-in-key-shuffler.js?v=2.3.3";
