import {MetronomePracticeInitializer} from "./metronome-practice-initializer.js?v=1.2.3";
import {MetronomePracticeTimer} from "./metronome-practice-timer.js?v=1.2.3";
