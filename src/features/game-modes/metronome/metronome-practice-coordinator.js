import {MetronomePracticeInitializer} from "./metronome-practice-initializer.js?v=1.6.1";
import {MetronomePracticeTimer} from "./metronome-practice-timer.js?v=1.6.1";
