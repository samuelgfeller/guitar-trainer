import {MetronomePracticeInitializer} from "./metronome-practice-initializer.js?v=2.1.0";
import {MetronomePracticeTimer} from "./metronome-practice-timer.js?v=2.1.0";
