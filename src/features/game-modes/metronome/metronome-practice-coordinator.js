import {MetronomePracticeInitializer} from "./metronome-practice-initializer.js?v=2.0.0";
import {MetronomePracticeTimer} from "./metronome-practice-timer.js?v=2.0.0";
