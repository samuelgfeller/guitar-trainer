...
import {GameNoteDisplayer} from "../../game-note-combination/game-note-displayer.js?v=1.0";
import {FretboardGameChallengingNotesProvider} from "./fretboard-game-challenging-notes-provider.js?v=1.0";
import {FretboardNoteGameCombinationGenerator} from "./fretboard-note-game-combination-generator.js?v=1.0";
import {FretboardNoteGameInitializer} from "./fretboard-note-game-initializer.js?v=1.0";
