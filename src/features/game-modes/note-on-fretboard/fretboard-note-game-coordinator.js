...
} from "../../../components/game-modes/note-on-fretboard/note-on-fretboard-note-handler.js?v=2.4.1";
import {NoteOnFretboardGameInitializer} from "./initialization/note-on-fretboard-game-initializer.js?v=2.4.1";
