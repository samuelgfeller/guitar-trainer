...
import {availableNotesOnStrings} from "../../../../components/configuration/config-data.js?v=2.4.1";
import {GameLevelTracker} from "../../../game-core/game-progress/game-level-tracker.js?v=2.4.1";
import {NoteOnFretboardEventListenerAdder} from "./note-on-fretboard-event-listener-adder.js?v=2.4.1";
