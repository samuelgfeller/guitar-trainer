import {MetronomeOperator} from "../metronome/metronome-operator.js?v=2.0.3";
import {TuneOperator} from "../tuner/tune-operator.js?v=2.0.3";
import {FrequencyBarsController} from "../frequency-bars/frequency-bars-controller.js?v=2.0.3";
import {GameElementsVisualizer} from "../game-ui/game-elements-visualizer.js?v=2.0.3";
import {ScreenWakeLocker} from "../wake-lock/screen-wake-locker.js?v=2.0.3";
