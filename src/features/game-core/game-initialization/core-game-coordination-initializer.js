import {CoreGameCoordinator} from "../game-start/core-game-coordinator.js?v=1.2.0";
import {
    FretboardNoteGameCoordinator
} from "../../game-modes/note-on-fretboard/fretboard-note-game-coordinator.js?v=1.2.0";
import {NoteInKeyGameCoordinator} from "../../game-modes/note-in-key/note-in-key-game-coordinator.js?v=1.2.0";
import {GameConfigurationManager} from "./game-configuration-manager.js?v=1.2.0";
import {GameElementsVisualizer} from "../game-ui/game-elements-visualizer.js?v=1.2.0";
import {MetronomePracticeCoordinator} from "../../game-modes/metronome/metronome-practice-coordinator.js?v=1.2.0";
