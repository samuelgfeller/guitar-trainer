...
import {CoreGameCoordinationInitializer} from "./core-game-coordination-initializer.js?v=2.3.2";
import {VisibilityChangeHandler} from "./visibility-change-handler.js?v=2.3.2";
import {GameElementsVisualizer} from "../game-ui/game-elements-visualizer.js?v=2.3.2";
import {ThemeSetter} from "../../../components/configuration/theme-setter.js?v=2.3.2";
