...
import {CoreGameCoordinationInitializer} from "./core-game-coordination-initializer.js?v=1.2.4";
import {VisibilityChangeHandler} from "./visibility-change-handler.js?v=1.2.4";
