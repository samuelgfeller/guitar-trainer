...
import {CoreGameCoordinationInitializer} from "./core-game-coordination-initializer.js?v=2.0.6";
import {VisibilityChangeHandler} from "./visibility-change-handler.js?v=2.0.6";
